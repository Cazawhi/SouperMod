package cazomod.utils;

import cazomod.CazoMod;
	...
	public void onRenderGameOverlay (RenderGameOverlayEvent event) {
		if(!event.isCancelable() && event.type == ElementType.EXPERIENCE) {
			...
			if(!mc.thePlayer.capabilities.isCreativeMode && mc.thePlayer.inventory.hasItemStack(Soup)) {
				...
				/* Rahmen */
				mc.renderEngine.bindTexture(new ResourceLocation("cazomod:textures/gui/soupermod_icons.png"));
				...
				mc.renderEngine.bindTexture(new ResourceLocation("cazomod:textures/gui/" + Suppenzahl + ".png"));
				...
				mc.renderEngine.bindTexture(new ResourceLocation("cazomod:textures/gui/" + Schusselzahl + ".png"));
